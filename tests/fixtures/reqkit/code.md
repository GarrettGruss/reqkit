...
class Tracer:
    ...
    # <rq-trace parent_id="223ea0" parent_rel="satisfy">
    ...
    def construct_report(self, trace_map: Dict[Optional[str], List[ReqkitBase]]) -> str:
        ...
        def report_lines(requirement: ReqkitRequirement, depth: int = 0) -> List[str]:
            ...
            # <rq-trace parent_id="e8c152" parent_rel="satisfy">
        ...
        # <rq-trace parent_id="eb29f1" parent_rel="satisfy">
        orphaned_traces = [
            o
            for o in all_objs
        ...
        # <rq-trace parent_id="5b24dd" parent_rel="satisfy">
        lines.append("")
